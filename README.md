...
Utviklingsmiljø: uv (Python 3.12), VS Code, git med SSH til et privat GitHub-repo.
Datapipeline: rådata → DuckDB → dbt (staging → marts).
Modell: en Poisson-styrkemodell som gir faktiske kampprediksjoner.
